...
const AboutHero = () => {
  return (
    <div className="bg-hero mt-[90px] md:mt-[100px] lg:mt-[120px]">
      <div className="w-full homepage-container px-[20px] md:px-[50px] lg:px-[100px] xl:px-[150px] 2xl:px-[213px] pt-[70px] md:pt-[70px] lg:pt-[75px] xl:pt-[80px] 2xl:pt-[80px] pb-[50px] lg:pb-[50px] 2xl:pb-[60px] mx-auto overflow-hidden">
        <p
