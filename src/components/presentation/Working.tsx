  ...
  return (
    <div className="w-full homepage-container homepage-padding px-[20px] md:px-[50px] lg:px-[70px] xl:px-[110px] 2xl:px-[213px] py-[50px] md:py-[70px] lg:py-[80px] xl:py-[70px] 2xl:py-[90px] mx-auto overflow-hidden">
      ...
      <div className="mt-[50px] lg:mt-[70px] 2xl:mt-[80px]">
        ...
        <div className="mt-[70px] lg:mt-0 flex flex-col lg:flex-row lg:items-center 2xl:items-center  gap-x-[50px] 2xl:gap-x-30px] gap-y-[70px]">
          <div className="flex flex-col lg:flex-row gap-x-[20px] 2xl:gap-x-[36px] w-full lg:w-[60%] 2xl:pl-[32px]">
            ...
            >
              ...
              <p className="text-center lg:text-left mt-[20px] lg:mt-[15px] xl:mt-[20px] font-montserrat font-medium text-[16px] md:text-[16px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px]">
                High-quality data is paramount to the success of our AI, akin to
                a well-organized crime scene being crucial for a detective's
                investigation. Billions of data points are collected from
                various sources, necessitating a meticulous data cleaning
                process. This process involves the identification and correction
                of errors, inconsistencies, or missing information within the
                data set. Imagine a typographical error in a company's earnings
                report; data cleaning ensures our AI operates with the most
        ...
        <div className=" mt-[70px] lg:mt-0 flex flex-col lg:flex-row lg:items-center 2xl:items-center gap-y-[70px] gap-x-[50px] 2xl:gap-x-30px]">
          <div className="flex flex-col lg:flex-row gap-x-[20px] 2xl:gap-x-[36px] w-full lg:w-[60%] 2xl:pl-[32px]">
            <div className="flex flex-col">
              <div className="relative w-full h-[50px] lg:h-[60px] 2xl:h-[77px] flex justify-center lg:justify-start">
                <img
            ...
            >
              ...
              <p className="text-center lg:text-left mt-[20px] lg:mt-[15px] xl:mt-[20px] font-montserrat font-medium text-[16px] md:text-[16px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px]">
                This stage unveils the true power of our system, the utilization
                of machine learning. Machine learning can be conceptualized as
                the ability to sift through billions of data points in search of
                hidden connections. By analyzing the data sets, our AI can
                identify patterns and correlations that might elude human
                observation. With over 50 years of historical data at its
                disposal, the AI is equipped to learn and recognize robust,
                consistent patterns that may signal potential stock movements
              </p>
            </div>
          </div>
          <div
